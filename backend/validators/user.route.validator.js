 ...
 * @typedef {import('express-validator').ValidationChain[]} UpdateUserValidator
 */

/**
 * Get user parameter validator
 * @typedef {import('express-validator').ValidationChain[]} GetUserParamValidator
 */
